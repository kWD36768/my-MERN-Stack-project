...
const UpdateCategory = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.REACT_APP_API_URL}/api/adminpanel/parentcategory/readparentcategorybyid/${_id}`
      )
  ...
  const handleupdatecategory = async (req, res) => {
    axios
      .put(
        `${process.env.REACT_APP_API_URL}/api/adminpanel/parentcategory/handleupdatecategory/${_id}`,
        {
          name: data.name,
          description: data.description,
        }
